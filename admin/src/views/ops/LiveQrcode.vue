...
/** 投放活码固定走主域，老码不用换。 */
const PROMO_BASE = 'https://naspt.vip/qr'
...
<template>
  <div class="page" v-loading="loading">
    <PageHeader
      title="活码 / 加群"
      description="群码与公众号可分别上传；站内弹窗与 naspt.vip/qr 共用。换群只换图，已发出去的投放码不用重打。"
    />
        ...
        <el-card shadow="never" class="block">
          ...
          <el-form label-width="100px">
            ...
            <el-form-item>
              ...
              <a class="preview-link" href="https://ik.naspt.vip/qr" target="_blank" rel="noopener">预览活码页</a>
            </el-form-item>
          </el-form>
        </el-card>
      </el-col>
    ...
    <el-card shadow="never" class="block" style="margin-top: 16px">
      <template #header>
        <div class="card-head">
          <span>推广活码（固定 https://naspt.vip/qr）</span>
          <div class="custom">
